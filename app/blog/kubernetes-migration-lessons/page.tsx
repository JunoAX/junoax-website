...
export default function KubernetesMigrationLessons() {
  const content = (
    <>
      <h2>Kubernetes Migration: Lessons Learned</h2>
      
      <p>Real-world insights from migrating enterprise applications to Kubernetes.</p>
      
      <p>This article covers essential insights and practical strategies for devops and cloud native. Our experience working with various organizations has shown that success in this area requires both strategic planning and practical implementation.</p>
      ...
      <div className="not-prose bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-6 my-8">
        <p className="text-lg font-semibold text-gray-900 mb-4">Need help with devops?</p>
